...
const Contact = () => {
  ...
  return (
    <div className="pb-24 md:pb-10 px-4 sm:px-0">
      ...
      <div className="mb-10 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
        {/* Contact Information */}
        <div className="flex flex-col">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 space-y-6">
            <div>
              <h2 className="font-semibold text-lg text-gray-700 mb-3">OUR OFFICE</h2>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center text-gray-600">
                ...
                <p>DocCare@business.com</p>
              </div>
            </div>
            
            <div className="pt-4">
              <h2 className="font-semibold text-lg text-gray-700 mb-2">CAREERS AT DocCare</h2>
              <p className="text-gray-600 mb-4">
                Learn more about our teams and job openings.
              </p>
              <button className="bg-primary text-white px-6 py-3 rounded-lg hover:bg-primary-dark transition-all duration-300 text-sm font-medium">
                Explore Jobs
              </button>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <h2 className="font-semibold text-lg text-gray-700 mb-4">GET IN TOUCH</h2>
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                className={`w-full py-3 rounded-lg font-medium text-white ${isSubmitting ? 'bg-gray-400' : 'bg-primary hover:bg-primary-dark'} transition-colors duration-300`}
              >
                {isSubmitting ? (
